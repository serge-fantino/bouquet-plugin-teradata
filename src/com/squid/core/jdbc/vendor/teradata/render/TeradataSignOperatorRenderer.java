 ...
 *
 * @author loivd Sign function for teradata
 */
public class TeradataSignOperatorRenderer extends BaseOperatorRenderer {
	public TeradataSignOperatorRenderer() {
	}

	@Override
	public String prettyPrint(SQLSkin skin, OperatorDefinition opDef, String[] args) throws RenderingException {
		if (args.length != 1) {
			throw new RenderingException("SIGN take 1 parameter only");
		}
		// SIGN(var)=var/ABS(var) in teradata
