 ...
 *
 * @author loivd Power function for Teradata
 */
public class TeradataPowerOperatorRenderer extends BaseOperatorRenderer {
	public TeradataPowerOperatorRenderer() {
	}

	@Override
	public String prettyPrint(SQLSkin skin, OperatorDefinition opDef, String[] args) throws RenderingException {
		if (args.length != 2) {
			throw new RenderingException("POWER must have 2 parameters");
		}
