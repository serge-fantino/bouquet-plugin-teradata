...
public class TeradataIJDBCDataFormater extends DefaultJDBCDataFormatter {

	public TeradataIJDBCDataFormater(DataFormatter formatter, Connection connection) {
		super(formatter, connection);
	}

	@Override
	public Object unboxJDBCObject(final Object column, final int colType) throws SQLException {
		return super.unboxJDBCObject(column, colType);
	}
